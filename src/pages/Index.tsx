    ...
    <div className="min-h-screen bg-[#4B5D78]">
      <div className="max-w-6xl mx-auto px-4 py-12 relative">
        ...
        <div className="bg-[#FFFFF0] rounded-lg p-8 shadow-lg prose prose-lg max-w-none">
          ...
          <p>ClefRights began as Mythoi Music, a music publishing company founded in 2019. The primary founder is Mary Lucia Darst, a classical violist who has over fifteen years experience in the music publishing sector. Through Mythoi Music, ClefRights is affiliated with the American Society for Composers, Authors, and Publishers (ASCAP). By January 2025, we will have an additional company named ClefRights that will have its publisher affiliation with Broadcast Music Incorporated (BMI). For licensing, ClefRights is enrolled with the Mechanical Licensing Collective (MLC), and Music Reports, Inc (MRI) to cover streaming rights, such as Spotify or Apple Music. ClefRights will be enrolled with the Harry Fox Agency (HFA) as well as the MLC and MRI. When the Global AI Music Registry launches in 2025, we will provide guidance to our artists on joining it and protecting their rights in regard to AI.</p>
